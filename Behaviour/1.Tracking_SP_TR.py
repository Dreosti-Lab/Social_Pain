...
lib_path = r'C:\Users\thoma\OneDrive\Documents\GitHub\Social_Pain\libs'
import sys
...
# Read Folder List
FolderlistFile = base_path + r'\TR_ISO.txt'
...
for idx,folder in enumerate(folderNames):
    ...
    # ---------------------
    # Process Video (NS)
    bonsaiFiles = folder + r'/Bonsai_ROI_Analysis.bonsai'
    ROIs = BONSAI_ARK.read_bonsai_crop_rois(bonsaiFiles)
    # Run more improved tracking in SP_video module
    fxS, fyS, bxS, byS, exS, eyS, areaS, ortS, motS = SPV.fish_tracking(folder, folder, ROIs, divisor=divisor, kSize=kernelWidth)
