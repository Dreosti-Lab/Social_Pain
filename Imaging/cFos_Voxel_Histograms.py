...
# Set Stack Path
folder_path ='S:/WIBR_Dreosti_Lab/Alizee/LSZ1_Server/Registration/Social/22_07_23/fish1'
...
# Histogram
histogram, bin_edges  = np.histogram(masked_values, bins = 100, range=[400,1600]);        
