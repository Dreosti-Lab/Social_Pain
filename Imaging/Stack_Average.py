...
folder_path = r'S:/WIBR_Dreosti_Lab/Alizee/LSZ1_Server/Registration/Heat'

folder_list = (folder_path  + '/NOXIOUS.txt')
...
Average_images = np.zeros((1000, 1000, 399), dtype = np.float32)
Divisor = np.zeros((1000, 1000, 399), dtype = np.float32)
Valid = np.zeros((1000, 1000, 399), dtype = np.float32)
...
nib.save(new_img, folder_path +  "/Average_N.nii.gz")
